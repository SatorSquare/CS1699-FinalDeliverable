...
public class TestLoginCorrectInfo {
  ...
  @Test
  public void testLoginCorrectInfo() throws Exception {
    ...
    assertEquals("SatorSquare", driver.findElement(By.linkText("SatorSquare")).getText());
  }
